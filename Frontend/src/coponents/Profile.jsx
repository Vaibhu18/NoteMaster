        ...
        <div className="flex justify-center mt-3">
          <div className=" w-[90%] md:w-[35%] p-3 rounded-[15px] shadow-[0px_0px_20px_-7px_black] bg-white">
            ...
            <div className="flex mt-3 justify-between">
              ...
              <div className="flex md:gap-3 gap-2 items-center justify-end">
                <NavLink className="flex bg-green-500 hover:bg-green-700  px-4 py-2 text-white font-[500] rounded-[10px]">
                  <span class="material-symbols-outlined">check_circle</span>
                </NavLink>
                <NavLink className="flex bg-blue-600 hover:bg-blue-700  px-4 py-2 text-white font-[500] rounded-[10px]">
                  <span class="material-symbols-outlined">edit</span>
                </NavLink>
                <NavLink className="flex bg-red-600 hover:bg-red-700  px-4 py-2 text-white font-[500] rounded-[10px]">
                  <span class="material-symbols-outlined">delete</span>
                </NavLink>
              </div>
            </div>
